...
class SocketHandler:
    def __init__(self, client, socket_trace = False, debug = True):
        ...
        self.socketDelay = 0
        self.socketDelayFetch = 360  # Reconnects every 120 seconds.
    ...
    def reconnect_handler(self):
        ...
        while True:
            if self.debug is True and self.active:
                # print(f"{threading.get_ident()}[socket][reconnect_handler] socketDelay : {self.socketDelay}")
                pass
